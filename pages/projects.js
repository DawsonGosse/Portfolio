...
export default function Project() {
  ...
  return (<Container>
    ...
    <ContentBlock>
        ...
        <LargeCard img={PostersLarge} title='Artwork' type='Graphic Design' roles='Roles - Creator' bio='Artwork, posters & illustrations all created by yours truly' bgcolor={themes[theme].Title} onCardClick={()=>router.push("/artwork")}></LargeCard>
    </ContentBlock>
    <Footer></Footer>
  </Container>
  )
